defmodule PhxBlogWeb.UserAuthTest do
  use PhxBlogWeb.ConnCase, async: true

  alias PhxBlog.Accounts
  alias PhxBlogWeb.UserAuth
  import PhxBlog.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, PhxBlogWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      PhxBlogWeb.Endpoint.subscribe(live_socket_id)
